...
class DaiSanKenkyuu implements BuildingDataInterface {
  @override
  String get buildingName => '第3研究室棟';

  @override
  String get imagePath => 'assets/daisankenkyuu.jpg';
  ...
  List<Facility> get toilets => [
    ...
    Facility(name: '男：小便器2　シャワートイレ1', floor: 2),
